...
var firebaseConfig = {
    apiKey: "AIzaSyB0wjg4S5fKGnHjyhUG3N_o1QayuRK4KSY",
    authDomain: "avaliacao-front.firebaseapp.com",
    projectId: "avaliacao-front",
    storageBucket: "avaliacao-front.appspot.com",
};
...
document.getElementById("meuFormulario").addEventListener("submit", function (event) {
    ...
    .then(function (docRef) {
        ...
        document.getElementById("tagVideo").value = ""; // Corrected line
    })
